...
def run_single(args, images_path, prediction_output, plot_dir):
    ...
    print(f"[INFO]  Running QuanFormer model...")
...
def main(args):
    ...
    print("[INFO] Starting QuanFormer - Simplified Mode")
    print("=" * 60)
    ...
    print("=" * 60)
    print("[✅ DONE] QuanFormer simplified run completed!")
    print("=" * 60)


if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="QuanFormer - Simplified Mode (Direct feature.csv + ROI images)"
    )
