...
from quanformer.util.misc import NestedTensor, is_main_process
...
class MobileNetBackboneBase(nn.Module):
    """MobileNet backbone with frozen BatchNorm."""
    def __init__(self, backbone: nn.Module, train_backbone: bool, num_channels: int, return_interm_layers: bool):
        super().__init__()
        return_layers = {'features': '18'}
        self.body = IntermediateLayerGetter(backbone, return_layers=return_layers)
        self.num_channels = num_channels
...
class MobileNetBackbone(MobileNetBackboneBase):
    def __init__(self, name: str,
                 train_backbone: bool,
                 return_interm_layers: bool,
                 dilation: bool):
