...
用法:
  python build_standard_curves.py --dir "D:\pycharm\MRMPFormer-main\results\batch_predictions"
  python build_standard_curves.py --dir "D:\pycharm\MRMPFormer-main\results\compare" --csv_pattern "compare_*.csv" --recursive --no_plots
