...
- AI input: `D:\yinlibo\MRMPFormer\model\project_review\full_rerun_random3000_20260916\inference_threshold06\all.csv`
- Peak/event rows: 50161
- Samples: 56
...
| value | count |
|---|---:|
| `MATCHED_UNIQUE` | 37562 |
| `AI_ONLY_EXTRA` | 10737 |
| `TRAD_ONLY_AI_MISS` | 1791 |
| `REFERENCE_MISSING` | 45 |
| `MATCHED_AMBIGUOUS` | 26 |
...
```json
{
  ...
  "trad_expected_rt_tolerance_min": 0.1,
